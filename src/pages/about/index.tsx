    ...
    <>
      ...
      <div>
        ...
        <p className="font-body opacity-80">
          WebGPU나 셰이더처럼 자료가 많지 않고 예상하지 못한 문제가 자주 생기는
          기술을 만지는 걸 좋아합니다. 오리 메시가 애니메이션에 따라 이상하게
          늘어나는 원인을 찾아 고치거나, 1MB 정도였던 모델을 267KB까지 줄이는
          것처럼 직접 문제를 발견하고 원인을 찾아가는 과정에서 재미를 느낍니다.
          처음에는 이유를 몰라도 하나씩 테스트해보고 바꿔보면서 결국 해결됐을 때
          가장 많이 배우는 것 같습니다.
        </p>
      </div>
    </>
    ...
    <>
      <div>
        ...
        <ul className="font-body opacity-80 mt-2  flex flex-col gap-2">
          ...
          <li>
            Shader와 TSL, NodeMaterial을 활용해 원하는 느낌의 커스텀 머티리얼과
            그래픽 효과를 직접 만들 수 있습니다.
          </li>
        </ul>
      </div>
      <div>
        ...
        <ul className="font-body opacity-80 mt-2  flex flex-col gap-2">
          <li>
            Flex, Grid, Media Query 등을 활용해 화면 크기에 따라 자연스럽게
            바뀌는 반응형 UI를 만들 수 있습니다.
          </li>
          <li>
            디자인 시안을 최대한 비슷하게 구현하면서도 모바일과 데스크탑에서
            사용하기 불편한 부분이 없는지 같이 확인하는 편입니다.
          </li>
        </ul>
      </div>
